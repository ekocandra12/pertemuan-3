...
fun main(){
    ...
    apabila tidak terdapat akses modifier-nya maka secara implisit akses modifier-nya adalah final.
    Sehingga apapun kelas dan method di Kotlin harus memiliki akses modifier open untuk
    menurunkan maupun meng-override methodnya. Sangat berbeda dengan Java dimana secara
    default kelas dan method di Java memiliki akses modifier open. Sehingga apapun kelas dapat
    diturunkan dan methodnya dapat di override (ditulis kembali) secara default-nya.
     */
}